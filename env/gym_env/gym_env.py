...
class GymEnv(BaseEnv):
    def __init__(self, gym_name:str, *args, render:bool = False, wrappers:list = None, **kwargs):
    ...
    def init(self):
        try:
            ...
            raise AttributeError(f"game '{self.name}' maybe not install, please check it.")
